		  ...
		  {        
			   ...
			   $upateorderidrun = $conn2->query($upateorderid);
				    ...
				    $_SESSION['plan_expiry_date']= $expiry_date;
					 echo"<script> 
					         alert(' Congrats, ".$_SESSION['user_dname']." : \n 1 month trial plan activated successfully.');
...
<div class="tab-content" id="myTabContent">
  ...
  <a <?php if($_SESSION['plan_txn_status'] == "Active"){ echo"href='/Welcome/?publishnewpost=1' ";}else{echo"href='#' data-toggle='modal' data-target='#chatfollowModal' ";}?>><button style ='margin-top:2px' class='btn btn-outline-success btn-sm float-right' type='button'>Publish New Post</button></a>
  <br><br>
  <div id='fetchpost'>
