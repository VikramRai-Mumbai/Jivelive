            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-danger shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Away Users</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php $uaway="SELECT username FROM user WHERE online='Away' ";if ($result_uaway=mysqli_query($conn4,$uaway)){$uaway_count=mysqli_num_rows($result_uaway);echo $uaway_count;mysqli_free_result($result_uaway);}?></div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php $INactiveUsers="SELECT username FROM user WHERE status='INActive' ";if ($result_INactiveUsers=mysqli_query($conn4,$INactiveUsers)){$INactiveUsers_count=mysqli_num_rows($result_INactiveUsers);if($INactiveUsers_count > 0){echo $INactiveUsers_count;}else{echo "0";}mysqli_free_result($result_INactiveUsers);}?></div>
                    </div>
                    <div class="col-auto">
                      <i class="fas fa-users fa-2x text-gray-300"></i>
                    </div>
