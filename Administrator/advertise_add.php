		 ...
		 <!-- Start of Dashboard - Users -->
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Add advertise Section: </h6>
            </div>
            <div class="card-body">
	...
	<?php 
		   	   ...
		   	   if(isset($_POST['heading']))
		   {
			    ...
			    if(!empty($_POST['heading']) and !empty($_POST['body'])){
					...
					$advertise_add= "INSERT INTO `advertise` (`aid`, `name`, `date`, `end_date`, `img`, `img_shape`, `width`, `height`, `img_margin`, `heading`,
       						`heading_fontsize`, `heading_color`, `subheading`, `sub_fontsize`, `sub_color`, `body`, `body_fontsize`, `body_color`,
							`place`, `category`, `status`) VALUES 
							(NULL, '".$_POST['name']."', '".$_POST['date']."', '".$_POST['end_date']."', '".$_POST['img']."', 'rounded-circle', '50px', '50px', 'mx-auto',
							'".$head."', 'h6',
							'Blue', '".$subhead."', '<p>', 'Green', '".$body."', '<p>', 'black', '".$_POST['place']."', '".$_POST['category']."', 'INActive')";
                  ...
                  $advertise_edit= "UPDATE `advertise` SET `name` = '".$_POST['name']."', `date` = '".$_POST['date']."',`end_date` = '".$_POST['end_date']."',
			          ...
			          if($conn2->query($advertise_add) === TRUE)
					  {
			         
				  echo "
				  <div class='alert alert-success' role='alert'>
				  <h4 class='alert-heading'>Well done!</h4>
				  <p>Looks good, you successfully Added Advertisement...<a href='index.php'>&larr; Back to Dashboard</a></p>
				</div>
